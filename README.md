...
The canonical production document and unchanged Token are stored in OpenBao at
`projects/opencodex/prod/cliproxy-inventory-api` (KV v2, version 3). The local
API document is explicitly ignored by Git because it contains the production
credential.
